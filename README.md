...
2. Download `TinyRoguesTrainingDummy-1.0.2.zip` from [Releases](https://github.com/tannerbyers/tinyrogues-training-dummy/releases).
...
```text
Tiny Rogues Training Dummy 1.0.2 loaded
```
